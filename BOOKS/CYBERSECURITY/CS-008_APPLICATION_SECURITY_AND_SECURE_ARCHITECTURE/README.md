# Application Security and Secure Architecture
...
This workspace contains the complete development environment for **Application Security and Secure Architecture**.

# Database Systems for Large Scale Applications
...
This workspace contains the complete development environment for **Database Systems for Large Scale Applications**.

# Retrieval Systems for Knowledge Intelligence
...
This workspace contains the complete development environment for **Retrieval Systems for Knowledge Intelligence**.
...
This book contains **37 planned chapters**.

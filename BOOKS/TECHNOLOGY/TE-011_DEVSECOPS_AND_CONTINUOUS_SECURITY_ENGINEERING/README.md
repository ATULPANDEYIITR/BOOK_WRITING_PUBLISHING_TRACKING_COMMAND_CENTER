# DevSecOps and Continuous Security Engineering
...
This workspace contains the complete development environment for **DevSecOps and Continuous Security Engineering**.
...
This book contains **29 planned chapters**.

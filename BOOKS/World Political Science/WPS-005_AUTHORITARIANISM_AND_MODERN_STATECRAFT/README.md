# Authoritarianism and Modern Statecraft
...
This workspace contains the complete development environment for **Authoritarianism and Modern Statecraft**.
...
This book contains **31 planned chapters**.

# Institutions Behind Modern Democracies
...
This workspace contains the complete development environment for **Institutions Behind Modern Democracies**.
...
This book contains **30 planned chapters**.

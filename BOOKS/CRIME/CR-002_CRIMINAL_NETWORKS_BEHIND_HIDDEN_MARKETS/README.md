# Criminal Networks Behind Hidden Markets
...
This workspace contains the complete development environment for **Criminal Networks Behind Hidden Markets**.
...
This book contains **34 planned chapters**.

# Forensics Evidence and Criminal Investigation
...
This workspace contains the complete development environment for **Forensics Evidence and Criminal Investigation**.
...
This book contains **36 planned chapters**.
